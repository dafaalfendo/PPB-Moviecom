...
public class FamilyFragment extends Fragment {
    ...
    private static final String URL_DATA = "https://api.themoviedb.org/3/genre/10751/movies?api_key=cecc9162a02c65190851eebec7025119&language=en-US&include_adult=false&sort_by=created_at.asc";

    private RecyclerView recyclerView;
    private RecyclerView.Adapter adapter;

    private List<FamilyListItem> listItems;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerViewFamily);
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                FamilyListItem item = new FamilyListItem(
                                        o.getString("title"),
                            ...
                            adapter = new FamilyAdapter(listItems, getActivity().getApplicationContext()); //mengirim ke adapter
