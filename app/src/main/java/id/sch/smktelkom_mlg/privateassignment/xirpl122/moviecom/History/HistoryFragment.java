...
public class HistoryFragment extends Fragment {
    private static final String URL_DATA = "https://api.themoviedb.org/3/genre/36/movies?api_key=cecc9162a02c65190851eebec7025119&language=en-US&include_adult=false&sort_by=created_at.asc";

    private RecyclerView recyclerView;
    private RecyclerView.Adapter adapter;

    private List<HistoryListItem> listItems;
                ...
                new Response.Listener<String>() { //aksi ketika api terload
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            adapter = new HistoryAdapter(listItems, getActivity().getApplicationContext()); //mengirim ke adapter
